...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text2png
```

A live public deployment of this template is available at [https://text2png.templates.workers.dev](https://text2png.templates.workers.dev)
